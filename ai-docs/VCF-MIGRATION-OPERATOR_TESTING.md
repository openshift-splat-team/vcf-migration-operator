# vcf-migration-operator Testing Guide
...
This guide covers all test suites for vcf-migration-operator and how to run them.
...
- `pull-ci-vcf-migration-operator-unit` - Unit tests
- `pull-ci-vcf-migration-operator-integration` - Integration tests (if enabled)
- `pull-ci-vcf-migration-operator-e2e-*` - E2E test suites

**Post-submit tests (run on merge):**
- `branch-ci-vcf-migration-operator-unit` - Unit tests
- `branch-ci-vcf-migration-operator-e2e-*` - Full E2E suite
...
- [Development Guide](vcf-migration-operator_DEVELOPMENT.md) - Build and development workflow
