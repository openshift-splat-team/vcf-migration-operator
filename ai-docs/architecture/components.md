# vcf-migration-operator Components
...
This document describes the major components and architecture of vcf-migration-operator.
...
- [Development Guide](../vcf-migration-operator_DEVELOPMENT.md) - How to build and run
- [Testing Guide](../vcf-migration-operator_TESTING.md) - How to test components
