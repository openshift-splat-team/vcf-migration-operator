# vcf-migration-operator Ecosystem and References
...
This document provides links to related projects, upstream dependencies, documentation, and external resources relevant to vcf-migration-operator.
...
**Relationship:** vcf-migration-operator runs on Kubernetes
...
**Relationship:** vcf-migration-operator is part of OpenShift platform
...
Key libraries and frameworks used by vcf-migration-operator:
...
- [Development Guide](../vcf-migration-operator_DEVELOPMENT.md) - Build and develop
- [Testing Guide](../vcf-migration-operator_TESTING.md) - Test suites
