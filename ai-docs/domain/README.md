# vcf-migration-operator Domain Models
...
This directory documents the domain models, custom resource definitions (CRDs), and core data structures used in vcf-migration-operator.
...
- [Development Guide](../vcf-migration-operator_DEVELOPMENT.md) - Adding new fields
